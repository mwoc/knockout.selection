    ...
    ko.bindingHandlers.selection = {
        modes: {
            single: function (selectionModel) {
                ...
                matchers.register({ type: 'mousedown', which: 1, hasItem: false }, function (event, item) {
            ...
            multi: function (selectionModel) {
                ...
                matchers.register({ type: 'mousedown', which: 1, ctrlKey: false, metaKey: false, shiftKey: false, hasItem: false }, function (event, item) {
                    selectionModel.selection([]);
                });
